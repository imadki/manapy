from helpers.Checker3D import Checker3D
from helpers.DomainTables import DomainTables
from helpers.TablesTestHexa3D import TablesTestHexa3D
import pytest
...
def test_main(nb_partition):
  ...
  test_tables = TablesTestHexa3D(float_precision, d_cell_loctoglob, g_cell_nodeid)
  test_tables.init()
