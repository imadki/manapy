...
LAPLACIAN_CONF = Struct(reuse_mtx=False, scheme="diamond", verbose=False)
...
def _solve_laplacian_2d(domain, func):
    ...
    solver = MUMPSSolver(domain=domain, var=var, conf=LAPLACIAN_CONF)
    solver()
...
class TestLaplacian2DRectangle:
    ...
    def test_linear_solution_x(self, domain_rectangle_2d):
        """
    ...
    def test_linear_solution_y(self, domain_rectangle_2d):
        """u(x,y) = y  →  Δu = 0."""
        domain = domain_rectangle_2d
        func = lambda x, y: y
        var = _solve_laplacian_2d(domain, func)
    ...
    def test_linear_solution_x_plus_y(self, domain_rectangle_2d):
        """u(x,y) = x + y  →  Δu = 0."""
        domain = domain_rectangle_2d
        func = lambda x, y: x + y
        var = _solve_laplacian_2d(domain, func)
    ...
    def test_harmonic_solution_x2_minus_y2(self, domain_rectangle_2d):
        """
    ...
    def test_constant_solution(self, domain_rectangle_2d):
        """
...
class TestLaplacian2DHybrid:
    ...
    def test_linear_solution_x(self, domain_hybrid_2d):
    ...
    def test_linear_solution_x_plus_y(self, domain_hybrid_2d):
        domain = domain_hybrid_2d
        func = lambda x, y: x + y
        var = _solve_laplacian_2d(domain, func)
        exact = func(domain.cells.center[:, 0], domain.cells.center[:, 1])
