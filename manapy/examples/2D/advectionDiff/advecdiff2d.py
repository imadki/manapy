...
#     MANAPY_DEVICE=cuda python3 advecdiff2d.py
config = ManapyConfig(
...
# Same solver as advection2d.py plus the diffusion tensor. Dxx/Dyy/Dzz feed both
# the dissipative residual and the CFL reduction; leaving them all at 0 turns
# the diffusion off and the solver degenerates to pure advection.
S = AdvectionDiffusionSolver(ne, vel=(u, v), Dxx=.01, Dyy=.01, order=2, cfl=0.8)
