...
import manapy.sys_solvers.shallowater.fvm_utils_compute as fvm_utils_compute
import manapy.sys_solvers.advecdiff.fvm_utils_compute as advecdiff_fvm_utils_compute
...
class ShallowWaterSolver:
  ...
  def stepper(self):
    ...
    self.dt = self.domain.halo_comm.graph_comm.allreduce(dt_c, MPI.MIN)
    return  self.dt
