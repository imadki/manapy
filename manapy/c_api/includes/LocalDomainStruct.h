...
struct LocalDomainStruct {
    ...
    PyArray<int32_t, 1> *halo_halosint = nullptr; // int32[:] [HalosIntConnectedToP1 halos ..., HalosIntConnectedToP2 halos ..., ...]; halos here are the local ID of the cell located in Px
