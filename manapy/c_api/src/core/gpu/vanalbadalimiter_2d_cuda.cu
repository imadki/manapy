...
#include "common/vanalbadalimiter_2d_common.hpp"
...
__global__ void vanalbadalimiter_2d_kernel(
  ...
  for (index_t i =
    ...
    vanalbadalimiter_2d_cell(i, w_c, w_ghost, w_halo, w_x, w_y, face_cellid,
...
void launch_vanalbadalimiter_2d(
  ...
  vanalbadalimiter_2d_kernel<<<blocks, threads, 0, stream>>>(
      w_c, w_ghost, w_halo, w_x, w_y, psi, face_cellid, cell_faceid, face_name,
      face_haloid, cell_center, face_center, nbelement);
}
