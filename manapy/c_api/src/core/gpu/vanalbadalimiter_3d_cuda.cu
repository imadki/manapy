...
#include "common/vanalbadalimiter_3d_common.hpp"
...
__global__ void vanalbadalimiter_3d_kernel(
  ...
  for (index_t i =
    ...
    vanalbadalimiter_3d_cell(i, w_c, w_ghost, w_halo, w_x, w_y, w_z, face_cellid,
...
void launch_vanalbadalimiter_3d(
  ...
  vanalbadalimiter_3d_kernel<<<blocks, threads, 0, stream>>>(
