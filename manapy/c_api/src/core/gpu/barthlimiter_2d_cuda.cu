...
#include "common/barthlimiter_2d_common.hpp"
...
__global__ void barthlimiter_2d_kernel(
  ...
  for (index_t i =
    ...
    barthlimiter_2d_cell(i, w_c, w_ghost, w_halo, w_x, w_y, face_cellid,
...
void launch_barthlimiter_2d(
  ...
  barthlimiter_2d_kernel<<<blocks, threads, 0, stream>>>(
