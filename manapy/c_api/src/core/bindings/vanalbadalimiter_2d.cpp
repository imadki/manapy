// Bindings for the van Albada / Venkatakrishnan limiter kernel. This
...
// place.
void vanalbadalimiter_2d_py(CFVec w_c, CFVec w_ghost, CFVec w_halo, CFVec w_x,
...
void vanalbadalimiter_2d_cuda_py(DCFVec w_c, DCFVec w_ghost, DCFVec w_halo,
  ...
  cuda_check(manapy_cuda_post_launch(), "vanalbadalimiter_2d kernel launch");
}

} // namespace

void register_vanalbadalimiter_2d(nb::module_ &m) {
  m.def("vanalbadalimiter_2d", &vanalbadalimiter_2d_py, nb::arg("w_c"),
        ...
        "gradient on a 2D unstructured mesh. Writes the result into psi in "
        "place.");

  m.def("vanalbadalimiter_2d_cuda", &vanalbadalimiter_2d_cuda_py,
        ...
        "reconstructed cell gradient on a 2D unstructured mesh. Takes device "
