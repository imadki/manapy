// Bindings for the 3D center-to-vertex kernel. This translation unit is
...
void center_to_vertex_3d_cuda_py(
  ...
  cuda_check(manapy_cuda_post_launch(), "center_to_vertex_3d kernel launch");
}
...
void register_center_to_vertex_3d(nb::module_ &m) {
  m.def(
      "center_to_vertex_3d", &center_to_vertex_3d_py, nb::arg("w_c"),
      ...
      "3D unstructured mesh. Writes the result into w_n in place.");

  m.def(
      "center_to_vertex_3d_cuda", &center_to_vertex_3d_cuda_py, nb::arg("w_c"),
      nb::arg("w_ghost"), nb::arg("w_halo"), nb::arg("w_haloghost"),
      nb::arg("cell_center"), nb::arg("halo_centvol"), nb::arg("node_cellid"),
      nb::arg("ghost_info_flt"), nb::arg("ghost_ext_info_flt"),
      nb::arg("node_ghostid"), nb::arg("node_haloghostid"),
      ...
      "vertices of a 3D unstructured mesh. Takes device arrays and writes the "
