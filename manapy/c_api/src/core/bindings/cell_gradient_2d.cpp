// Bindings for the cell-gradient kernel. This translation unit is compiled
...
// written in place.
void cell_gradient_2d_py(CFVec w_c, CFVec w_ghost, CFVec w_halo,
  ...
  (void)cell_periodicfid; // unused by the kernel, kept for signature parity
  ...
  cell_gradient_2d(
      ...
      make_view<const index_t, 2>(cells),
...
void cell_gradient_2d_cuda_py(
  ...
  cuda_check(manapy_cuda_post_launch(), "cell_gradient_2d kernel launch");
}

} // namespace

void register_cell_gradient_2d(nb::module_ &m) {
  m.def("cell_gradient_2d", &cell_gradient_2d_py, nb::arg("w_c"),
        ...
        "Least-squares gradient of a cell field on a 2D unstructured mesh. "
        "Writes the result into w_x, w_y, w_z in place.");

  m.def("cell_gradient_2d_cuda", &cell_gradient_2d_cuda_py, nb::arg("w_c"),
        nb::arg("w_ghost"), nb::arg("w_halo"), nb::arg("w_haloghost"),
        nb::arg("cell_center"), nb::arg("cell_cellnid"),
        nb::arg("ghost_info_flt"), nb::arg("ghost_ext_info_flt"),
        nb::arg("cell_ghostnid"), nb::arg("cell_haloghostnid"),
        ...
        nb::arg("w_x").noconvert(), nb::arg("w_y").noconvert(),
        nb::arg("w_z").noconvert(), nb::arg("ghost_faceid"),
        "GPU (CuPy) least-squares gradient of a cell field on a 2D "
