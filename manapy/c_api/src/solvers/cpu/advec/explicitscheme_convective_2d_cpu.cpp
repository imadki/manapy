...
#include "common/advec/explicitscheme_convective_2d_common.hpp"
...
void explicitscheme_convective_2d(
  ...
  for (index_t k = 0; k < n_inner; ++k)
    explicitscheme_convective_2d_face<ConvectiveFaceKind::Inner>(
  ...
  for (index_t k = 0; k < n_periodic; ++k)
    explicitscheme_convective_2d_face<ConvectiveFaceKind::Periodic>(
  ...
  for (index_t k = 0; k < n_halo; ++k)
    explicitscheme_convective_2d_face<ConvectiveFaceKind::Halo>(
  ...
  for (index_t k = 0; k < n_boundary; ++k)
    explicitscheme_convective_2d_face<ConvectiveFaceKind::Boundary>(
