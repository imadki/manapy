// Bindings for the advecdiff 3D explicit convective residual kernel. Compiled
...
// Argument order matches the Python original with an explicit `scheme` at the
// end. All three velocity-gradient components (w_z / wz_halo) are used in 3D.
...
// GPU version: device (CuPy) arrays; rez_w written in place on the GPU.
void explicitscheme_convective_3d_cuda_py(
  ...
  cuda_check(manapy_cuda_post_launch(), "explicitscheme_convective_3d kernel launch");
}
...
void register_advecdiff_explicitscheme_convective_3d(nb::module_ &m) {
  m.def("explicitscheme_convective_3d", &explicitscheme_convective_3d_py,
        ...
        "advecdiff explicit convective residual for 3D linear advection. "
  ...
  m.def("explicitscheme_convective_3d_cuda",
        ...
        nb::arg("d_boundaryfaces"), nb::arg("d_periodicboundaryfaces"),
        nb::arg("cell_shift"), nb::arg("order"), nb::arg("scheme"),
        "GPU (CuPy) advecdiff explicit convective residual for 3D linear "
