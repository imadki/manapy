// Bindings for the advecdiff diffusion (dissipative) residual kernel. Compiled
...
void register_advecdiff_explicitscheme_dissipative(nb::module_ &m) {
  m.def(
      "explicitscheme_dissipative", &explicitscheme_dissipative_py,
      ...
      nb::arg("Dzz"),
      "advecdiff diffusion (dissipative) residual: accumulates the anisotropic "
  ...
  m.def("explicitscheme_dissipative_cuda", &explicitscheme_dissipative_cuda_py,
        ...
        nb::arg("dissip_w").noconvert(), nb::arg("Dxx"), nb::arg("Dyy"),
        nb::arg("Dzz"),
        "GPU (CuPy) advecdiff diffusion (dissipative) residual. Takes device "
        "arrays and writes dissip_w in place on the GPU.");
}
