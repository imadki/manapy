...
__global__ void explicitscheme_convective_2d_kernel(
  ...
  for (index_t k =
       ...
       k < nfaces; k += stride) {
    explicitscheme_convective_2d_face<Kind>(
...
void launch_face_list(ArrayView<const index_t, 1> faces, cudaStream_t stream,
  ...
  explicitscheme_convective_2d_kernel<Kind>
...
void launch_explicitscheme_convective_2d(
  ...
  launch_face_list<ConvectiveFaceKind::Periodic>(
      ...
      v_face, w_face, w_x, w_y, wx_halo, wy_halo, psi, psi_halo, cell_center,
