"""Kernels compiled for float32 data and int64 indices.
...
Import whichever you need, e.g. `from manapy_compute_32_64 import core`
or `from manapy_compute_32_64.solvers import advec`.
"""

# Submodules are separate compiled extensions, so they are loaded lazily (PEP
# 562): `manapy_compute_32_64.domain` works without an explicit
# `import manapy_compute_32_64.domain` first, while nothing dlopens its .so
