    ...
    for p in range(self.nb_partitions):
      ...
      for i in range(len(d_cell_loctoglob)):
        ...
        for k in range(cnb_nodes):
          ...
          c_node_cellid = c_node_ghostcenter_info[:, 0][0:c_nb_ghost]
          c_node_cellid = c_node_cellid
          ...
          c_ghostinfo[0:c_nb_ghost, 4] = c_node_ghostcenter_info[0:c_nb_ghost, 1] # face_old_name
