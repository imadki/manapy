// Cube periodique [0,1]^3, transfini (structure), pour manapy.
// Tags manapy : in=11(x=0) out=22(x=Lx) upper=33(y=Ly) bottom=44(y=0)
//               front=55(z=0) back=66(z=Lz)
// NB: se genere sous gmsh mais manapy REJETTE le maillage au build
//     ("cellid must exist for a physical face") -- probleme de split tetra
//     transfini (triangles de bord non conformes aux faces des tetras),
//     independant du periodique.

N = 8;   // cellules par direction
...
Line(1) = {1,2}; Line(2) = {2,3}; Line(3) = {3,4}; Line(4) = {4,1};   // z=0
Line(5) = {5,6}; Line(6) = {6,7}; Line(7) = {7,8}; Line(8) = {8,5};   // z=1
Line(9) = {1,5}; Line(10) = {2,6}; Line(11) = {3,7}; Line(12) = {4,8}; // verticales
...
// Correspondance periodique (translation) — necessaire pour un maillage conforme
