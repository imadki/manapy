// Structured HEXAHEDRAL mesh of the unit cube [0,1]^3 (transfinite + recombine).
// manapy boundary tags: in=11(x=0) out=22(x=1) upper=33(y=1) bottom=44(y=0)
//                       front=55(z=0) back=66(z=1).
//   gmsh -3 hex_cube.geo -o hex_cube.msh
N = 16;   // cells per edge
