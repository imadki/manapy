...
void ImGui_ImplVulkan_UpdateTexture(ImTextureData* tex)
{
    ...
    if (tex->Status == ImTextureStatus_WantCreate) {
        ...
        backend_tex->DescriptorSet =
            ImGui_ImplVulkan_AddTexture(bd->TexSamplerLinear,
                                             ...
                                             VkImageUsageFlags            image_usage)
{
    ...
    if (wd->UseDynamicRendering == false) {
        ...
        if (attachment.format == VK_FORMAT_UNDEFINED) attachment.format = wd->SurfaceFormat.format;
...
static void ImGui_ImplVulkan_CreateWindow(ImGuiViewport* viewport)
{
    ...
    wd->PresentMode = ImGui_ImplVulkanH_SelectPresentMode(v->PhysicalDevice,
                                                          wd->Surface,
                                                          &present_modes[0],
...
#endif
        bd->PipelineForViewports = ImGui_ImplVulkan_CreatePipeline(v->Device,
                                                                   v->Allocator,
                                                                   VK_NULL_HANDLE,
...
static void ImGui_ImplVulkan_RenderWindow(ImGuiViewport* viewport, void*)
{
    ...
    ImGui_ImplVulkan_RenderDrawData(viewport->DrawData,
                                    fd->CommandBuffer,
