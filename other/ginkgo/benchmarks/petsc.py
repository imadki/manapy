...
arr = parse_petsc_benchmarks("./petsc_benchmarks_zero.txt")
arr = filter(arr)
...
active_solver_name = ["bicg", "bcgs", "cg", "gcr", "gmres", "cgs"]
active_preconditioners = ["jacobi", "bjacobi", "pbjacobi", "ilu", "gamg"]
# active_exec = ["cpu-1", "cpu-4"]
